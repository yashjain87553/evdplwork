 ...
 */
class FeatureDisplay extends \Magento\Config\Block\System\Config\Form\Field
{
	/**
	...
	protected function _getElementHtml(AbstractElement $element)
	{
		...
		$html .= '<p>Use following code to show featured brand block in any place which you want.</p>';
		...
		$html .= '<pre style="background-color: #f5f5dc"><code>' . $this->_escaper->escapeHtml('<?php
   echo $block->getLayout()
	->createBlock("Mageplaza\Shopbybrand\Block\Brand\Featured")
	->toHtml();
?>') . '</code></pre>';
