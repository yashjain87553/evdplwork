 ...
 */
class CategoryId extends AbstractBrand implements BlockInterface
{
    /**
     * @var string
     */
    ...
    public function __construct(Context $context, BrandFactory $brandFactory,
        CategoryFactory $categoryFactory, Helper $helper
    ) {
    ...
    public function getOptionIds()
    {
        ...
        $result = [];
        $brands = $this->_categoryFactory->create()->getCategoryCollection(
            $sql, null
        )->getData();
